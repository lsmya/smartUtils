...
public class SpannableStringUtils {
     ...
     * @return {@link Builder}
     */
    public static Builder getBuilder(Context context, @ColorInt int defaultColor) {
        return new Builder("", context, defaultColor);
    }
    ...
    public static class Builder {
        ...
        private Builder(@NonNull CharSequence text, Context context, @ColorInt int defaultColor) {
            this.text = text;
         ...
         * @return {@link Builder}
         */
        public Builder append(@NonNull CharSequence text, @NonNull View.OnClickListener listener) {
            this.append(text)
                    .setClickSpan(new MyClickableSpan(defaultValue) {
                        @Override
         ...
         * @return {@link Builder}
         */
        public Builder append(CharSequence text, @ColorInt int color, @NonNull View.OnClickListener listener) {
            this.append(text)
                    .setForegroundColor(color)
                    .setFlag(Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                    .setClickSpan(new MyClickableSpan(color) {
                        @Override
                        public void onClick(@NonNull View widget) {
                            super.onClick(widget);
                            listener.onClick(widget);
    ...
    public static class MyClickableSpan extends ClickableSpan {
        ...
        public MyClickableSpan(@ColorInt int color) {
            mColor = color;
        }
